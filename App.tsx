...
export default function App() {
  ...
  function ExamsAccordion() {
    ...
    const filteredRoles = ROLES.filter(item => `${item.name} ${item.special}`.toLocaleLowerCase('tr-TR').includes(examSearch.trim().toLocaleLowerCase('tr-TR')));
