...
export default function App() {
  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="light" />{compactHeader ? MobileHeader : Header}{screen === 'home' && Home()}{screen === 'exams' && ExamsAccordion()}{screen === 'role-info' && RoleInfo()}{screen === 'study' && StudySetup()}{screen === 'quiz' && Quiz()}{screen === 'result' && Result()}{screen === 'membership' && Membership()}{screen === 'progress' && Progress()}{screen === 'admin' && isAdmin && Admin()}{screen === 'auth' && Auth()}{screen === 'reset-password' && ResetPassword()}{screen === 'legal' && Legal()}</SafeAreaView>;
}
