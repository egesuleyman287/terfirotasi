...
const ICISLERI_LOGO = { uri: 'https://static.daktilo.com/sites/1085/uploads/2022/06/17/large/tc-icisleri-bakanligi.png' };
...
const DEFAULT_TOPIC = DEFAULT_INSTITUTION.roles[0].topics[0];
...
export default function App() {
  ...
  const [authRole, setAuthRole] = useState<Role>(DEFAULT_ROLE);
  ...
  const [studyRole, setStudyRole] = useState<Role>(DEFAULT_ROLE);
  const [studyTopic, setStudyTopic] = useState(DEFAULT_TOPIC);
  ...
  const [adminTopic, setAdminTopic] = useState(DEFAULT_TOPIC);
