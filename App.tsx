...
export default function App() {
  ...
  function Home() { const memberRole = (user?.role as Role) ?? ROLES[0].name; return <ScrollView contentContainerStyle={styles.page}><View style={{ backgroundColor: COLORS.white, borderWidth: 1, borderColor: '#DCE7EE', borderRadius: 16, padding: compactHeader ? 19 : 30, flexDirection: 'row', flexWrap: 'wrap', gap: compactHeader ? 0 : 26, shadowColor: '#163A52', shadowOpacity: .08, shadowRadius: 14, shadowOffset: { width: 0, height: 5 }, elevation: 2 }}><View style={{ flex: 1, minWidth: compactHeader ? 0 : 470, gap: compactHeader ? 10 : 13 }}><View style={{ alignSelf: 'flex-start', backgroundColor: '#EAF5FA', borderRadius: 99, paddingHorizontal: 11, paddingVertical: 6 }}><Text style={{ color: COLORS.blue, fontWeight: '900', fontSize: 11, letterSpacing: .7 }}>SINAV HAZIRLIK PLATFORMU</Text></View><Text style={{ color: COLORS.ink, fontSize: compactHeader ? 27 : 35, fontWeight: '900', letterSpacing: -.5, lineHeight: compactHeader ? 34 : 43 }}>Terfi hedefin için{`\n`}doğru rotayı oluştur.</Text><Text style={{ color: '#5D6D7C', fontSize: compactHeader ? 14 : 16, lineHeight: compactHeader ? 21 : 24 }}>Unvanına göre konu çalış, güncel sorularla bilgini pekiştir ve gelişimini analiz et.</Text><Pressable onPress={() => user ? openStudy(memberRole) : (() => { setAuthMode('signup'); setAuthFeedback(null); setScreen('auth'); })()} style={{ alignSelf: compactHeader ? 'stretch' : 'flex-start', backgroundColor: COLORS.blue, paddingHorizontal: 22, paddingVertical: 13, borderRadius: 9, marginTop: compactHeader ? 2 : 5, alignItems: 'center' }}><Text style={{ color: COLORS.white, fontSize: 14, fontWeight: '900' }}>{user ? 'HEMEN BAŞLA' : 'ROTANI OLUŞTUR'}</Text></Pressable></View>{!compactHeader && <View style={{ width: 270, borderLeftWidth: 1, borderLeftColor: '#DCE7EE', paddingLeft: 26, paddingVertical: 8, gap: 13, justifyContent: 'center' }}><Text style={{ color: COLORS.blue, fontWeight: '900', fontSize: 12, letterSpacing: .5 }}>3 ADIMDA HAZIRLAN</Text><View style={{ gap: 11 }}><View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}><View style={{ width: 27, height: 27, borderRadius: 14, backgroundColor: COLORS.blue, alignItems: 'center', justifyContent: 'center' }}><Text style={{ color: COLORS.white, fontWeight: '900', fontSize: 12 }}>1</Text></View><Text style={{ color: COLORS.ink, fontWeight: '800' }}>Konunu seç</Text></View><View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}><View style={{ width: 27, height: 27, borderRadius: 14, backgroundColor: COLORS.blue, alignItems: 'center', justifyContent: 'center' }}><Text style={{ color: COLORS.white, fontWeight: '900', fontSize: 12 }}>2</Text></View><Text style={{ color: COLORS.ink, fontWeight: '800' }}>Soruları çöz</Text></View><View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}><View style={{ width: 27, height: 27, borderRadius: 14, backgroundColor: COLORS.blue, alignItems: 'center', justifyContent: 'center' }}><Text style={{ color: COLORS.white, fontWeight: '900', fontSize: 12 }}>3</Text></View><Text style={{ color: COLORS.ink, fontWeight: '800' }}>Analizini gör</Text></View></View></View>}</View><View style={{ flexDirection: 'row', gap: 9 }}><View style={styles.stat}><Text style={styles.statValue}>9</Text><Text style={styles.small}>Unvan</Text></View><View style={styles.stat}><Text style={styles.statValue}>11</Text><Text style={styles.small}>Sınav konusu</Text></View><View style={styles.stat}><Text style={styles.statValue}>{published}+</Text><Text style={styles.small}>Mevcut soru</Text></View></View><CurrentExamCards /><Footer /></ScrollView>; }
