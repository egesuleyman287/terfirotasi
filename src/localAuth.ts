...
export type LocalUser = { name: string; email: string; institution?: string; role?: string; city?: string; phone?: string; id?: string; accessToken?: string; refreshToken?: string; accessTokenExpiresAt?: number };
